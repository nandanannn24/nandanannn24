...
&nbsp;
<img src="https://komarev.com/ghpvc/?username=nandanannn24&style=for-the-badge&color=9d4edd&label=PROFILE_SCANS&abbreviated=true"/>
...
<br/>
<sub><code>VMware · MikroTik · Bash Scripting to look like a hacker</code></sub>

</td>
<td width="50%" valign="top" align="center">

#### ⬡ FRONTEND & WEB 3D EXPERIENCES

<img src="https://skillicons.dev/icons?i=react,ts,js,tailwind,vite,threejs,figma&theme=dark&perline=7" />

<br/>
<sub><code>WebGL & Minimalist Glassmorphism is my signature</code></sub>
...
<br/>
<sub><code>n8n · LLM APIs · Automating things because I'm lazy</code></sub>
...
<br/>
<sub><code>Blender · Premiere · After Effects — Ko Tim's requests</code></sub>
...
│  DESC    : Automating my entire workflow so I     │
│            don't have to work manually. Aggre-    │
│            gating multiple LLMs with n8n pipe-    │
│            lines. Built out of pure laziness,     │
│            which is the mother of all innovation. │
└───────────────────────────────────────────────────┘
```
...
│  DESC    : Digital room reservation system for    │
│            UPN Jatim. Looks simple, but the       │
│            scheduling logic gave me severe acid   │
│            reflux. Role-based access, real-time   │
│            slot management — all functional.      │
│            Currently waiting for campus approval. │
└───────────────────────────────────────────────────┘
```
...
│  TEAM    : "Sekawan Papat" (The Four Horsemen)    │
│  DESC    : SME owners can manage products &       │
│            access business analytics. Python REST │
│            backend + React SPA frontend. Pure     │
│            blood, sweat, and code. The grind with │
│            Sekawan Papat paid off. We made it. 🔥  │
└───────────────────────────────────────────────────┘
```
...
│  STATUS  : 🟢 LIVE                                 │
│  DESC    : Full-feature TypeScript e-commerce for │
│            TEM Production. Writing Three.js       │
│            custom shaders almost gave me a fever  │
│            — literally. Three days bedridden.     │
│            But the aesthetics are immaculate.     │
...
### `〔 06 〕` ⬡ DEADLINE HEARTBEAT SENSOR

<img src="https://github-readme-activity-graph.vercel.app/graph?username=nandanannn24&bg_color=0b0914&color=00f5ff&line=9d4edd&point=00f5ff&area=true&area_color=9d4edd&hide_border=true&custom_title=CONTRIBUTION+SPIKES+BEFORE+DEADLINES&radius=8" width="95%"/>
...
### `〔 07 〕` ⬡ TROPHY CABINET — ACHIEVEMENTS UNLOCKED
...
### `〔 08 〕` ⬡ INITIATE HANDSHAKE PROTOCOL
...
```bash
# CONTACT PROTOCOL :: TRANSMISSION CHANNELS
$ curl --request COLLAB \
    --url "mailto:priyogalistyoananda26@gmail.com" \
    --header "Subject: [COLLAB] Let's build something insane" \
    --data "{
      'from'    : 'YOU',
      'intent'  : 'HIRE ME / LET'\''S BUILD SOMETHING',
      'note'    : 'Will reply in 24h unless Ko Tim needs
                   me to work overtime.'
    }"

# WARNING : Don't say "can you help me real quick?"
#           In developer dictionaries, 'real quick'
#           does not exist.
# NOTE    : Pak Ajun, if you're reading this,
#           please grade me generously Sir. 🙏
```

> **Open to:** 3D Web experiences, AI integrations,
> or high-paying freelance gigs.
> I do not accept "exposure" as payment.
...
[![Email](https://img.shields.io/badge/GMAIL-priyogalistyoananda26%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white&labelColor=0b0914)](mailto:priyogalistyoananda26@gmail.com)

<br/>

[![GitHub](https://img.shields.io/badge/GITHUB-nandanannn24-00f5ff?style=for-the-badge&logo=github&logoColor=white&labelColor=0b0914)](https://github.com/nandanannn24)

<br/>

![IG Ayang](https://img.shields.io/badge/IG_AYANG-Data_Science_2022-C13584?style=for-the-badge&logo=instagram&logoColor=white&labelColor=0b0914)

<br/>

![Available](https://img.shields.io/badge/STATUS-OPEN_FOR_WORK-00f5ff?style=for-the-badge&labelColor=0b0914)
...
<img src="https://capsule-render.vercel.app/api?type=waving&height=120&color=0:0b0914,50:1e1136,100:0b0914&section=footer&text=&fontColor=00f5ff&fontSize=0" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=13&duration=4000&pause=1000&color=b829ea&center=true&vCenter=true&width=700&height=30&lines=%22Hard+work+beats+talent%2C+but+dark+mode+beats+everything.%22;%22Please+pass+me%2C+Pak+Ajun.%22;%22Code%2C+Deploy%2C+Sleep%2C+Repeat.%22" />

<br/>

<sub>
<code>
⬡ Architected while sleep-deprived by
<a href="https://github.com/nandanannn24">nandanannn24</a>
· Powered by ☕, Indomie, and Freya mechanics.
</code>
</sub>
